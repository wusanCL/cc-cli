// ps：真的做了很多版本的处理，这是一种知识底蕴，一种积累，慢慢来

const Module = require('module')    //内置模块   
const path = require('path')

const semver = require('semver')

// module的作用：当项目逐渐庞大的时候，目录层级变深，我们的require语句就会变的特别丑，是否有什么模块加载机制的优化方式呢？就是使用module模块   可以尝试更改里面的path数组
